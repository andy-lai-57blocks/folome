...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (videoElement) {
        // Make video clickable - change cursor style
        videoElement.style.cursor = 'pointer';
        
        // Add click event to open app store URL
        videoElement.addEventListener('click', function() {
            // Store in session that the user has completed viewing the video
            sessionStorage.setItem('rewarded2', 'true');
            
            // Open the Candy Crush app page in a new tab
            window.open('https://apps.apple.com/us/app/candy-crush-saga/id553834731', '_blank');
        });
